"""
Django settings for zahraa_portfolio project.
...
EMAIL_HOST_USER = os.environ.get('EMAIL_USER')     # from .env
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_PASS') # from .env

DEFAULT_FROM_EMAIL = EMAIL_HOST_USER
DEFAULT_TO_EMAIL = 'zahraadelbani4@gmail.com'
